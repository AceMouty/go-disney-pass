...
CREATE TABLE IF NOT EXISTS area_rides(
  id SERIAL PRIMARY KEY,
  area_id INTEGER REFERENCES park_area(id) ON DELETE CASCADE,
  ride_name NVARCHAR(255) NOT NULL,
  CONSTRAINT fk_area_rides_area_id FOREIGN KEY (area_id) REFERENCES park_area(id)
);
